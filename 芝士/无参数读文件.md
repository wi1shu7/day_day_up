...
- `chr(46)`就是字符`.`
  ...
  ![](../daydayup.assets/image-20230719173621207.png)

  `chr(current(localtime(time())))`：数组第一个值每秒+1，所以最多60秒就一定能得到46，用`current`或者`pos`就能获得`.`

  ![](../daydayup.assets/image-20230719173926887.png)
...
- `crypt()`：
  ...
  ![](../daydayup.assets/image-20230719182620374.png)
  ...
  ![](../daydayup.assets/image-20230719183135310.png)
...
![](../daydayup.assets/image-20230719184112763.png)
...
![](../daydayup.assets/image-20230719190241851.png)
...
![](../daydayup.assets/image-20230720172405756.png)
...
![](../daydayup.assets/image-20230720172811801.png)
...
![](../daydayup.assets/image-20230720175902183.png)

**读取多层上层路径文件：**

`array_rand(array_flip(scandir(dirname(chdir(next(scandir(dirname(chdir(dirname(getcwd()))))))))));`
![](../daydayup.assets/image-20230720172840411.png)
...
![](../daydayup.assets/image-20230720180542945.png)
...
![](../daydayup.assets/image-20230720182030861.png)
